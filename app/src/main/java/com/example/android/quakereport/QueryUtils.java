...
*/
     ...
     */
    public static ArrayList<quakes> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONArray featuresList =(JSONArray) baseJsonResponse.get("features");

            // For each earthquake in the earthquakeArray, create an {@link Earthquake} obje
            for (int j=0; j<featuresList.length();j++)
            {   JSONObject currentEarthquake  =featuresList.getJSONObject(j);
                ...
                // Create a new {@link quakes} object with the magnitude, location, time,
